<h4 class="fw-bold py-3" style="padding-bottom: 0rem !important;">تعديل بيانات المورد </h4>
<!-- Basic Layout -->
<form action="{{ route('admin.suppliers.update', $supplier->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder=""
                            name="balance" value="{{ $supplier->balance }}" required />
                        @error('balance')
                            <span class="text-danger w-100 fs-6">{{ $message }}</span>
                        @enderror
                    </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary btn-sm">تحديث المورد</button>
    </div>
</form>
