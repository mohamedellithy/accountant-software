            ...
            <div class="card-header py-3 ">
                ...
                <form id="filter-data" method="get" class=" justify-content-between">
                    <div class="d-flex justify-content-between" style="/*background-color: #eee;*/">
                        <div class="nav-item d-flex align-items-center m-2" style="background-color: #fff;padding: 0px;border: 2px solid;">
               ...
               <table class="table">
                   ...
                   <tbody class="table-border-bottom-0">
                        @foreach ($customerReturns as $customerReturn)
                            <tr>
                               <td>{{ IndexList($customerReturns,$loop) }}</td>  
                                <td class="width-16">
                                    <strong>
                                ...
                                <td class="width-16">
                                    @if($customerReturn?->customer)
                                        @if($customerReturn?->customer?->deleted_at == null)
                                            <a class="crud" href="{{ route('admin.customers.show', $customerReturn?->customer?->id) }}">
